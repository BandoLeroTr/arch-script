...
os.system("pacman -S picom nitrogen rofi thunar htop lxappearance vivaldi")
...
root_passwd = input("root_passwd: ")
user_name = input("username: ")
user_passwd = input("password: ")

if root_passwd :
    os.system("passwd {}".format((root_passwd)))

if user_name :
    os.system("useradd -m {}".format((user_name)))
    
if user_passwd :
    os.system("passwd {}".format((user_passwd)))
